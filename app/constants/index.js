...
export const navigation = [
  ...
  export const PROJECT2 = [
    {
      id: 2,
      name: "National Relief Planning",
      description:
        "ReliefChain lets disaster victims submit details like family size, income, and home damage. A map shows their eligibility based on location, plus nearby victims’ info. Relief organizations log in, verify, and airdrop aid directly, with a final confirmation screen.",
      image: stormImage,
